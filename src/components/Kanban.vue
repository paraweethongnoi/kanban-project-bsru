...
export default {
  ...
  methods: {
    ...
    submit_create_task() {
      this.create_tesk_submin(this.current_column_index, {
...
.column {
  ...
  margin: 25px;
  padding: 15px;
  -webkit-box-shadow: 10px 10px 18px -15px rgba(255, 255, 255, 1);
  -moz-box-shadow: 10px 10px 18px -15px rgba(255, 255, 255, 1);
  box-shadow: 10px 10px 18px -15px rgba(255, 255, 255, 1);
}
.column-header {
  display: flex;
  align-items: center;
...
.create-task {
  ...
  padding: 10px;
  border-radius: 5px;
  background-color: rgb(245, 135, 152);
  cursor: pointer;
}
.create-task:hover {
  background-color: rgba(233, 150, 122, 0.678);
}
.input-task-name {
  width: 100%;
}
.task {
  ...
  border-radius: 2px;
  margin: 10px;
  background-color: rgb(214, 141, 178);
}
.drop_zone {
  height: 10px;
}
